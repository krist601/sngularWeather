//
//  LocationsWeatherListInteractorTests.swift
//  SngularTests
//
...
class LocationsWeatherListInteractorTests: XCTestCase {
    var presenter: LocationsWeatherListPresenter!
    var mock: MockLocationsWeatherListService!

    override func setUp() {
        presenter = LocationsWeatherListPresenter()
        mock = MockLocationsWeatherListService()
